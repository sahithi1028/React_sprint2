...
export function AdminRegistration() {
    ...
    const loginSubmit = async (e) => {
        e.preventDefault();
        const data = { adminName, email, password, mobileNo };
                    ...
                    <form>
                        ...
                        <div className="ui  form">
                            <div>
                                ...
                                <input type="text" required placeholder="Given Name" value={adminName} onChange={e => setAdminName(e.target.value)}></input>
                            </div>
                            <div >
